...
class BubbleSortTest < Test::Unit::TestCase
  ...
  def test_bubble_sort
    assert bubble_sort(@empty) == @empty.sort
    assert bubble_sort(@one) == @one.sort
    assert bubble_sort(@two) == @two.sort
    assert bubble_sort(@many) == @many.sort
    assert bubble_sort(@identical) == @identical.sort
