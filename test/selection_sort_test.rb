...
class SelectionSortTest < Test::Unit::TestCase
  ...
  def test_selection_sort
    assert selection_sort(@empty) == @empty.sort
    assert selection_sort(@one) == @one.sort
    assert selection_sort(@two) == @two.sort
    assert selection_sort(@many) == @many.sort
    assert selection_sort(@identical) == @identical.sort
